...
// around this on a Unix system as follows:
// 
// MPlayer-RC responds to SIGUSR1 and SIGUSR2 signals by executing
// previous track and next track commands. This allows you to put
// something like this in your input.conf (for MPV)
// 
...
//     > run "killall -SIGUSR2 mplayer-rc"
// 
// and your < and > keys should then work again. With MPV, you can even
// put something like this
// 
//     < playlist_prev ; run killall -SIGUSR1 mplayer-rc
//     > playlist_next ; run killall -SIGUSR2 mplayer-rc
// 
// which should then do the right thing whether you run MPV directly or
// as a backend to MPlayer-RC.
// 
// Command remapping
// 
