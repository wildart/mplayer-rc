...
// https://f-droid.org or direct from the Android-VLC-Remote author at
// https://code.google.com/p/android-vlc-remote/. VLC itself is not
// required since MPlayer-ARC acts as a translator, conveying "VLC
